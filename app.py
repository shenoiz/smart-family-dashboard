...
def get_panchang():
    ...
    try:
        ...
        result = {
            'tithi':     data.get('tithi', [{}])[0].get('name') if data.get('tithi') else None,
            'nakshatra': data.get('nakshatra', [{}])[0].get('name') if data.get('nakshatra') else None,
            'vaara':     data.get('vaara'),
            'festivals': [f.get('name') for f in data.get('festivals', [])] if data.get('festivals') else [],
        }
